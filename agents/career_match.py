...
Весовая модель карьеры (применяй строго):
- [ВЫСОКИЙ ВКЛАД — текущая роль]: максимальный вес, 100% релевантности
- [ВЫСОКИЙ ВКЛАД] (последние 7 лет): высокий вес, особенно лидерство и трансформация
- [СРЕДНИЙ ВКЛАД] (8–15 лет назад): средний вес, особенно если enterprise-масштаб, M&A, PMO
- [КОНТЕКСТ — ранний опыт] (>15 лет назад): низкий вес, только базовые компетенции
- Трансформационные вехи в [СРЕДНИЙ ВКЛАД] и [КОНТЕКСТ] сохраняют стратегическую ценность
